import{_ as s,o as n,c as a,U as e}from"./chunks/framework.a7041386.js";const u=JSON.parse('{"title":"面向对象","description":"","frontmatter":{"tag":["TS"]},"headers":[],"relativePath":"TS/面向对象特性.md","filePath":"TS/面向对象特性.md","lastUpdated":null}'),p={name:"TS/面向对象特性.md"},l=e(`<h1 id="面向对象" tabindex="-1">面向对象 <a class="header-anchor" href="#面向对象" aria-label="Permalink to &quot;面向对象&quot;">​</a></h1><p>在 TypeScript 中，面向对象编程有三大特性：封装、继承和多态。</p><h2 id="封装" tabindex="-1">封装 <a class="header-anchor" href="#封装" aria-label="Permalink to &quot;封装&quot;">​</a></h2><p>封装是指将数据和方法相结合，形成一个有机的整体，同时隐藏了对象的内部细节，只向外部暴露必要的接口。这样可以保护对象的数据不被随意修改，同时也提高了代码的可维护性。</p><p>在 TypeScript 中，可以使用 <code>public</code>、<code>private</code> 和 <code>protected</code> 访问修饰符来实现封装。其中，<code>public</code> 表示公有，可以在任何地方访问；<code>private</code> 表示私有，只能在类内部访问；<code>protected</code> 表示受保护的，可以在类内及其子类中访问。</p><p>下面是一个使用封装的例子：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">class Person {</span></span>
